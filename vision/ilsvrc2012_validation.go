...
func init() {
	config.AfterInit(func() {
		...
		iLSVRC2012Validation224CenterCrop875RecordIO = &ILSVRC2012ValidationRecordIO{
			...
			imageSize:      224,
			baseURL:        "https://s3.amazonaws.com/store.carml.org/datasets/ilsvrc2012_validation_224_center_crop_875",
			listFileName:   "imagenet1k-val.lst",
			indexFileName:  "imagenet1k-val.idx",
			recordFileName: "imagenet1k-val.rec",
			centerCrop:     87.5,
		...
		iLSVRC2012Validation227CenterCrop875RecordIO = &ILSVRC2012ValidationRecordIO{
			...
			imageSize:      227,
			baseURL:        "https://s3.amazonaws.com/store.carml.org/datasets/ilsvrc2012_validation_227_center_crop_875",
			listFileName:   "imagenet1k-val.lst",
			indexFileName:  "imagenet1k-val.idx",
			recordFileName: "imagenet1k-val.rec",
			centerCrop:     87.5,
		...
		iLSVRC2012Validation299CenterCrop875RecordIO = &ILSVRC2012ValidationRecordIO{
			...
			imageSize:      299,
			baseURL:        "https://s3.amazonaws.com/store.carml.org/datasets/ilsvrc2012_validation_299_center_crop_875",
			listFileName:   "imagenet1k-val.lst",
			indexFileName:  "imagenet1k-val.idx",
			recordFileName: "imagenet1k-val.rec",
			centerCrop:     87.5,
